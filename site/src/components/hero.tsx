  ...
  return (
    <section className="relative overflow-hidden border-b border-rule bg-bone">
      ...
      <div className="relative mx-auto max-w-[900px] px-5 pt-14 pb-16 text-center sm:px-8 sm:pt-20 sm:pb-24 lg:pt-28 lg:pb-32">
        ...
        <p className="rise cap mb-7 text-gold-ink" style={{ animationDelay: "80ms" }}>
          {t.hero.eyebrow}
        </p>
        ...
        >
          {t.hero.headlineLead}{" "}
          <span className="text-gold-ink">{t.hero.headlineAccent}</span>
        </h1>
        ...
        >
          <WhatsAppButton tone="solid">{t.hero.primaryCta}</WhatsAppButton>
          <a
            href="#services"
        ...
        <p className="rise mt-9 text-[0.85rem] text-muted" style={{ animationDelay: "380ms" }}>
          {t.hero.fine}
        </p>
      </div>
      ...
      <div className="rise relative -mt-2 sm:-mt-4" style={{ animationDelay: "460ms" }}>
        <ImageBand
